...
@interface JXEmitterButton ()

/** weak类型 粒子发射器图层 */
@property (nonatomic, weak)  CAEmitterLayer *emitterLayer;

@property (nonatomic, assign) JXEmitterButtonType type;
...
@implementation JXEmitterButton
...
- (void)setup {
    ...
    emitterCell.contents         = (id)[UIImage imageNamed:@"yellow_good_25x25_"].CGImage;
    ...
    emitterCell3.contents        = (id)[UIImage imageNamed:@"yellow_good_25x25_"].CGImage;
...
- (void)startFire{
    ...
    // 每秒喷射的80个
    [self.emitterLayer setValue:@120 forKeyPath:@"emitterCells.emitterCell.birthRate"];
    [self.emitterLayer setValue:@120 forKeyPath:@"emitterCells.emitterCell3.birthRate"];
    // 开始
